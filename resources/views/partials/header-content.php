      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        ...
        <div class="dropdown-body">
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            ...
            <a href="#" class="dropdown-item">
              <span>
                <svg class="pcasset(t-muted me-2">
            ...
            <div class="card border-0 shadow-none drp-upgrade-card mb-0" style="background-image: url(<?= asset('assets/images/layout/img-profile-card.jpg') ?>)">
              <div class="card-body">
                <div class="user-group">
                  <img src="<?= asset('assets/images/user/avatar-1.jpg') ?>" alt="user-image" class="avtar" />
