        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="pc-component">
                    <div class="alert alert-primary my-3" role="alert">
                        <div class="avtar avtar-s"><i data-feather="alert-circle"></i></div>
                        This maps is using AIS data from MarineTraffic
                    </div>
                </div>
            </div>
            <div class="my-3">
                ...
                onEachFeature: function (feature, layer) {
                    ...
                    if (feature.properties) {
                        if (feature.properties.name === 'PULAUNATUNABESAR') {
                            popupContent =
                                '<b>Pulau Natuna Besar</b><br>Penjelasan: Pulau Natuna Besar adalah pulau terbesar di Kepulauan Natuna dan berfungsi sebagai pusat administrasi dan militer Indonesia di kawasan tersebut. Pulau ini memiliki fasilitas militer termasuk pangkalan angkatan laut dan udara, yang penting untuk mengamankan wilayah perbatasan dan jalur pelayaran.<br><br><i>Sumber daya yang ada di Pulau Natuna Besar: <br> a. Sumber Daya Laut: Ikan karang, terumbu karang, moluska, dan berbagai jenis biota laut. <br> b. Potensi Pariwisata: Diving dan snorkeling karena keindahan terumbu karang.</i>';
                            label = 'Pulau Natuna Besar';
                            ...
                            label = 'Karang Unarang';
                        } else if (feature.properties.name === 'ZEE') {
                            popupContent =
                                '<b>Laut Cina Selatan di dekat perbatasan ZEE Indonesia</b><br>Penjelasan: Titik ini merupakan bagian dari perairan yang sering menjadi sengketa di Laut Cina Selatan, di mana terjadi tumpang tindih klaim wilayah antara beberapa negara. Keberadaan militer dan patroli rutin di daerah ini penting untuk mempertahankan hak maritim Indonesia dan memastikan keamanan jalur pelayaran internasional.<br><br><i>Sumber daya yang ada di Laut Cina Selatan: <br> a. Minyak dan Gas Bumi: Cadangan besar minyak dan gas alam di bawah dasar laut. <br> b. Sumber Daya Perikanan: Beragam jenis ikan, termasuk ikan tuna, cakalang, dan kerapu. <br> c. Keanekaragaman Hayati Laut: Terumbu karang dan berbagai jenis biota laut.</i>';
                            label = 'ZEE';
                        } else if (feature.properties.name === 'PULAULAUT') {
                            popupContent =
                                '<b>Pulau Laut</b><br>Pulau ini adalah salah satu pulau terbesar di wilayah Natuna Utara yang menawarkan pantai pasir putih yang indah, air laut yang jernih, dan terumbu karang yang mempesona. Selain wisata bahari, tempat ini juga sering menjadi lokasi penangkapan ikan. <br>';
                            label = 'Pulau Laut';
                        } else if (feature.properties.name === 'KARANGLUCIPARABESAR') {
                            popupContent =
                                '<b>Karang Lucipara Besar</b><br>Karang Lucipara Besar merupakan salah satu spot terbaik untuk diving karena terumbu karangnya yang sangat indah dan beragam spesies ikan. Tempat ini juga merupakan habitat penting bagi biota laut.';
                            label = 'Karang Lucipara Besar';
                        } else if (feature.properties.name === 'BLOCKDALPHA') {
                            popupContent =
                                '<b>Blok D Alpha</b><br>Blok D Alpha merupakan wilayah yang merupakan bagian dari Cekungan Natuna Timur. Cekungan ini dikenal memiliki potensi cadangan gas alam yang cukup besar serta terdapat cadangan minyak bumi di dalamnya.';
                            label = 'Blok D Alpha';
                        } else if (feature.properties.name === 'TELUKBUTON') {
                            popupContent =
                                '<b>Teluk Buton</b><br>Teluk buton dikenal karena keindahan alamnya yang masih alami, dengan pantai berpasir putih, air laut yang jernih, dan dikelilingi oleh hutan tropis. Selain menjadi lokasi penting untuk kegiatan perikanan, Teluk Buton juga memiliki potensi besar sebagai destinasi wisata bahari yang belum banyak dikembangkan.';
                            label = 'Teluk Buton';
                        } else if (feature.properties.name === 'TERRITORIESCLAIMEDCHINA') {
                            popupContent =
                                '<b>Klaim Teritori China</b><br>Klaim teritori China di Laut Natuna merupakan bagian dari klaim "Nine-Dash Line," di mana China mengklaim sebagian besar Laut China Selatan, termasuk wilayah yang tumpang tindih dengan Zona Ekonomi Eksklusif (ZEE) Indonesia di sekitar Kepulauan Natuna.';
                            label = 'Klaim Teritori China';
                        } else {
