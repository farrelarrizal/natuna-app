            ...
            <div class="mt-2 row align-items-center">
              <div class="col-12">
                ...
                <p class="text-primary mb-0">
                  <span class="badge bg-light-success mb-0 mt-1 text-bold text-md">Very High</span>
                </p>
              </div>
            </div>
          </div>          
    ...
    {{-- <div class="col-md-3">
      <div class="card bg-success">
        <div class="card-header">
          <h3 class="mb-0">Overall Indicator: </h3>
        </div>
        <div class="card-body">
          <div class="">
            <h4 class=""><strong>VERY HIGH</strong></h4>
            <h5>5/5</h5>
          </div>
          <br>
        </div>
      ...
      {{-- <div class="col-md-9">
          <div class="card">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Natuna Indicator</h4>
              </div>
                ...
                <div class="col-md-4 col-xl-4">
                  <div class="mt-3 row align-items-center">
                    <div class="col-12">
                      ...
                      <h4 class="mb-0 p-3 color-block text-blue-500">4,275/5</h4>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-xl-4">
                  <div class="mt-3 row align-items-center">
                    <div class="col-12">
                      ...
                      <h4 class="mb-0 p-3 color-block text-red-500">3,625/5</h4>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-xl-4">
                  <div class="mt-3 row align-items-center">
                    <div class="col-12">
                      ...
                      <h4 class="mb-0 p-3 color-block text-green-500">4,485/5</h4>
                    </div>
                  </div>
                </div>
              </div>
