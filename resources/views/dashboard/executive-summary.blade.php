...
@section('content')
  ...
  <!-- if isBaseModelRun = 0 show the alert -->
  @if($isBaseModelRun == 0)
    <div class="alert alert-danger" role="alert">
        <h4 class="alert-heading">Please run the base model first!</h4>
        <hr>
        <p>
            You need to run the base model first before you can view the executive summary. Visit the <a href="{{url('hankam/simulation/base-model')}}">Base Model</a> page to run the base model.
        </p>
      </div>
  @else
    ...
    <div class="row col-lg-12">
      ...
      <div>
        {{-- @if($all_indicator == 'UNKNOWN')
          <div class="alert alert-warning d-flex align-items-center mt-2 mx-2" role="alert">
            <i class="fas fa-info-circle me-2"></i>
            <div>Please create a scenario to see the forecast indicator</div>
          </div>
        @else --}}
          <div class="row col-lg-12">
